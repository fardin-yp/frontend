...
const Seo = ({ Seoroute , info  })=>{
    ...
    const postHandler = async (e)=>{
        ...
        try {
            if (Seoroute === "new-seo") {
                await axios__WEBPACK_IMPORTED_MODULE_2___default().post("http://dreamweb.runflare.run/adminRoute/Seo", post, {
    ...
    const updateHandler = async (id)=>{
        ...
        try {
            if (Seoroute === "edit-seo") {
                await axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://dreamweb.runflare.run/adminRoute/SeoUpdate", post, {
                    withCredentials: true
                }).then((res)=>{
                    if (res.data.errMessage) {
                        alert(res.data.errMessage);
    ...
    const serviceHandler = async (e)=>{
        ...
        try {
            if (Seoroute === "seo-service") {
                await axios__WEBPACK_IMPORTED_MODULE_2___default().post("http://dreamweb.runflare.run/adminRoute/seoService", post, {
                    withCredentials: true
                }).then((res)=>{
                    if (res.data.errMessage) {
                        alert(res.data.errMessage);
