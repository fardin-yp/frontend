...
const Exclusive = ()=>{
    ...
    const { 0: arr , 1: setArr  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    ...
    const postHandler = async (e)=>{
        ...
        setLoading(true);
        try {
            await axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://dreamweb.runflare.run/adminRoute/exclusiveForm", newform, {
    ...
    const GetForm = async ()=>{
        try {
            await axios__WEBPACK_IMPORTED_MODULE_2___default().get("http://dreamweb.runflare.run/adminRoute/exclusiveForm", {
                withCredentials: true
            }).then((res)=>{
    ...
    const update = async (e)=>{
        ...
        try {
            ...
            setForm(newArr);
            setLoading(true);
            axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://dreamweb.runflare.run/adminRoute/exclusiveForm", newArr, {
                withCredentials: true
            }).then((res)=>{
                if (res.data.errMessage) {
                    alert(res.data, errMessage);
