...
const editProducts = ()=>{
    ...
    const getProducts = async ()=>{
        await axios__WEBPACK_IMPORTED_MODULE_2___default().get("http://dreamweb.runflare.run/allRoutes/allProducts").then((res)=>{
    ...
    const postHandler = async (e)=>{
        ...
        try {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://dreamweb.runflare.run/adminRoute/ProductsUpdate", formData, {
    ...
    const deletePR = async (e)=>{
        ...
        await axios__WEBPACK_IMPORTED_MODULE_2___default().put(`http://dreamweb.runflare.run/adminRoute/delete/product/${deleteProduct._id}`, post, {
            withCredentials: true
        }).then((res)=>{
            alert(res.data.Message);
            setLoading(false);
