...
const editAricle = ()=>{
    ...
    const postHandler = async (e)=>{
        ...
        try {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_2___default().put("http://dreamweb.runflare.run/adminRoute/ArticleUpdate", formData, {
    ...
    const getArticles = async ()=>{
        await axios__WEBPACK_IMPORTED_MODULE_2___default().get('http://dreamweb.runflare.run/allRoutes/articles', {
            withCredentials: true
        }).then((res)=>{
    ...
    const deletePR = async (e)=>{
        ...
        setLoading(true);
        await axios__WEBPACK_IMPORTED_MODULE_2___default().put(`http://dreamweb.runflare.run/adminRoute/delete/articles/${deleteProduct._id} `, post, {
            withCredentials: true
        }).then((res)=>{
            alert(res.data.Message);
            setLoading(false);
    ...
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            ...
            !edit && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                style: {
                    height: "100%",
                    marginTop: "-10px"
                },
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: "tableEdit-holder",
                        children: articles.length > 0 && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
