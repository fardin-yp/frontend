...
const panel = ({ info  })=>{
    ...
    const NewAdmin = async (e)=>{
        ...
        setLoading(true);
        try {
            await axios__WEBPACK_IMPORTED_MODULE_1___default().post("http://dreamweb.runflare.run/auth/signup", post, {
    ...
    const editAdmin = async (e)=>{
        ...
        setLoading(true);
        try {
            await axios__WEBPACK_IMPORTED_MODULE_1___default().put("http://dreamweb.runflare.run/auth/editAdmin", post, {
                withCredentials: true
            }).then((res)=>{
                if (res.data.errMessage) {
                    setError(res.data.errMessage);
