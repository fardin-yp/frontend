...
const Users = ({ info  })=>{
    ...
    const sendLinks = async (e)=>{
        e.preventDefault();
        await axios__WEBPACK_IMPORTED_MODULE_2___default().post(`http://dreamweb.runflare.run/adminRoute/Links`, {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const getLinks = async ()=>{
            await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`http://dreamweb.runflare.run/allRoutes/Links`, {
                withCredentials: true
            }).then((res)=>{
