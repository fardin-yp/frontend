...
const Comment = ({ comments , id , link , admin , type , reCaptcha  })=>{
    ...
    const { find  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_helpers_context_authContext__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z);
    ...
    async function sendmessage(e) {
        ...
        try {
            await axios__WEBPACK_IMPORTED_MODULE_2___default().put(`http://dreamweb.runflare.run/comment/${link}`, message, {
    ...
    const deleteComment = async (messId)=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_2___default().post(`http://dreamweb.runflare.run/adminRoute/removeComment/${type}`, posts, {
            withCredentials: true
        }).then((res)=>{
                    ...
                    children: [
                        slice && slice.map((mes)=>{
                            return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                className: "mess",
                                children: [
                                    mes.answer && mes.answer !== "false" && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                        id: "reply-arrow",
                                        src: "/uploads/reply.png",
                                        alt: "reply"
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        className: mes.answer && mes.answer !== "false" ? "c-top-answer" : "c-top",
                                        style: mes.admin ? {
                                            background: "#0d2040",
                                            color: "white"
                                        } : null,
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                children: [
                                                    mes.answer && mes.answer !== "false" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                                                        style: mes.answer && mes.answer !== "false" ? {
                                                            fontSize: "14px",
                                                            backgroundColor: "#6e787f",
                                                            width: "max-content",
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                                src: mes.admin ? '/uploads/user.png' : '/uploads/user.png',
                                                alt: "user"
                                            })
                                        ]
                                    }),
                                    ...
                                    mes.answer === "false" && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                                        href: "#hh",
                                        onClick: ()=>setAnswer(mes.name)
                                        ,
                                        children: "پاسخ"
                                    }),
