...
var exports = {};
exports.id = 1025;
exports.ids = [1025,2149,3970,2208,6157,3309];
exports.modules = {
...
const ResetPassword = ({ logged  })=>{
    ...
    async function reset(e) {
        ...
        try {
            await axios__WEBPACK_IMPORTED_MODULE_1___default().post('http://dreamweb.runflare.run/authentication/reset', post).then((res)=>{
...
var __webpack_exports__ = (__webpack_exec__(1997));
