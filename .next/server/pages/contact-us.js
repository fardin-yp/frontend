...
const index = ({ json , jsonSeo , links  })=>{
    ...
    const post = async (e)=>{
        ...
        try {
            await axios__WEBPACK_IMPORTED_MODULE_4___default().post('https://dreamweb.runflare.run/allRoutes/contact', ex).then((res)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [5675,7513,7129,2088], () => (__webpack_exec__(8983)));
