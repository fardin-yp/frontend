...
var exports = {};
exports.id = 8321;
exports.ids = [8321,2149,3970,2208,6157,3309];
exports.modules = {
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_navbar_navbar__WEBPACK_IMPORTED_MODULE_3__, _helpers_context_authContext__WEBPACK_IMPORTED_MODULE_8__]);
([_components_navbar_navbar__WEBPACK_IMPORTED_MODULE_3__, _helpers_context_authContext__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const index = ({ json , user  })=>{
    const { find  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_helpers_context_authContext__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z);
    ...
    const sendEx = async (e)=>{
        ...
        try {
            await axios__WEBPACK_IMPORTED_MODULE_6___default().post('http://dreamweb.runflare.run/allRoutes/exclusive', ex).then((res)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [5675,7513,7365,6195], () => (__webpack_exec__(5041)));
