           ...
           <form style={{padding:"20px"}} onSubmit={postHandler}>
            ...
            <select style={{ marginTop:"-20px",zIndex:"12",width:"80%",background:"#ff9800",color:"white"}} onChange={(e) => setSelect(e.target.value)}>      
                ...
                {filter && filter.map(res => {
                    ...
                    <div className="article-holder">
                    <input value={title} style={{width:"86%"}} placeholder="عنوان" type='text' onChange={(e) => setTitle(e.target.value)} />
                    ...
                    <textarea value={keywords} placeholder="حروف کلیدی" type='text' onChange={(e) => setKeyword(e.target.value)} />
                </div>
